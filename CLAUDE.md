...
**최종 갱신 2026-09-16 · 로드맵 36차(2026-09-16) 기준 · `main` raw 대조 완료**
...
5. **게스트에게 열리는 건 지도 플로팅 카드와 주변 도감 목록까지다** *(2026-09-16 개정, 구 "플로팅 카드 하나뿐")*. 상세 페이지와 모든 쓰기는 로그인 게이트. 컬럼 차단은 DB 뷰가, 화면 차단은 UI가 한다
