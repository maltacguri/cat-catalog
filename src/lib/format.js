...
export const COPY = {
  ...
  // §2.16 NoticePanel(「이용 안내」) 본문 — 소제목 + 문단 배열
    ...
    {
      title: '',
      paragraphs: ['캠퍼스에서 우연히 마주친 고양이를 알아보게 하려고 만들었어요.',
        '찾아가기보다는 우연히 만나는 쪽이었으면 해서, 지금 어디 있는지는 알려주지 않아요. 고양이의 위치는 1시간 뒤에 지도에 나타나요. 찾아가는 것을 방지하기 위한 수단이에요.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '한 마리에게 밥이 몰리는 것도 좋지 않아서, 같은 고양이에게 2시간 안에 다시 주려고 하면 한 번 더 물어봐요. 물은 언제든 괜찮아요.',
      ],
    },
    {
